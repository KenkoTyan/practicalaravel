            ...
            <div class="itc-slider__wrapper">
                <div class="itc-slider__list">
                    ...
                    <div class="itc-slider__item">
                        ...
                        <img class="catalog-card__item--thumbnail card-item" src="<?php echo e(asset('/storage/products/' . $sliderProduct->thumbnail)); ?>" alt="картинка товара">
                            <p class="">назв: <?php echo e($sliderProduct->name); ?></p>
                            <p class="">цена: <?php echo e($sliderProduct->price); ?> руб.</p>
                        </div>
                    </div>
